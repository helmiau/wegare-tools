        ...
        <div class="row py-2">
            <div class="col-lg-6 col-md-12 mx-auto mt-3">
                <div class="card bg-info bg-transparent box-shadow">
                    <div class="col-lg-12">
                        <h4 class="text-center my-4"><i class="fa fa-cogs"></i> STL by Wegare</h4>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="pb-lg-2">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-4">
                                    <label>SNI</label>
                                    <input type="text" class="form-control" placeholder="bug.com" value="<?php if ($bug2) echo implode($bug2); ?>"  id="bug" required>
                                </div>
                            </div>
                            <div class="pb-lg-2">
                            ...
                            <div class="pb-lg-2 text-center">
                                <button type="submit" onclick="saveConfig();" id="saveConfig" class="btn btn-primary btn-block"><i class="fa fa-floppy-o"></i> Save</button>
                            </div>
                        </div>
                    </div>
                </div>
